  ...
  Widget build(BuildContext context) {
    ...
    return RepositoryProvider(
      ...
      child: MultiBlocProvider(
          ...
          child: BlocListener<ProductCategoriesBloc, ProductCategoriesState>(listener: (contextInventory, stateInventory){
            if(stateInventory is ErrorLoadingProductCategoryState){
              messagesSnackBar(stateInventory.errorApi);
              onBack();
            }
          }, child: BlocBuilder<ProductCategoriesBloc, ProductCategoriesState>(
              builder: (contextInventory, stateInventory) {
                if (stateInventory is LoadProductCategoryState) {
