...
class AmountInventoryDialog {
  ...
  final CyclicalInventoryProductModel? cyclicalInventoryProductModel;
  ...
  void showDialogCyclicalInventory(CyclicalInventoryProductModel cyclicalInventoryProductModel) {
    TextEditingController productAmountController = TextEditingController();
    AwesomeDialog(
        context: context,
        dialogType: DialogType.infoReverse,
        ...
        body: BlocProvider<DialogInputAddAmountBloc>(create: (context) => DialogInputAddAmountBloc(),
          child: Center(
            child: BlocBuilder<DialogInputAddAmountBloc, DialogInputAddAmountState>(builder: (contextInputAddAmount, stateInputAddAmount){
              ...
              return Column(
                children: [
                  Text(cyclicalInventoryProductModel.product,
                    style: TextStyle(
                        fontStyle: FontStyle.italic,
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                  ...
                  if (cyclicalInventoryProductModel.count != 0)
                    Container(
                      height: 40,
                      width: 40,
                      decoration: BoxDecoration(
                      ...
                      child: Center(
                        child: Text("${cyclicalInventoryProductModel.count}",
                          style: TextStyle(
                            color: TColor.white,
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
        ...
        btnOkOnPress: (){
          ...
          if (amount.isEmpty){
            ...
            context.read<InputAddAmountBloc>().add(InputAmountEvent(id: cyclicalInventoryProductModel.id, amount: int.parse(amount)));
            Navigator.of(context).pop();
          }
        },
        btnCancelText: "CANCELAR",
